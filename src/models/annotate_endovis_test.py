...
def annotate(start_id=0):
    ...
    base_dir = 'C:/lior/studies/master/projects/calibration/regression calibration/Tracking_Robotic_Testing/Tracking/'
    dataset = 'Dataset6'
    data_dir = base_dir + dataset
    img_file_names = sorted(glob(data_dir + '/frames/*.png'))
