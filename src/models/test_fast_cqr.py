...
def eval_test_set(save_params=False, load_params=False, mix_indices=True, calc_mean=False, save_test=False, load_test=False):
    ...
    if not load_preds:
        ...
        y_p_calib_original, targets_calib_original, valid_visual = get_arrays(calib_loader, model, device, dataset = dataset)
        y_p_test_original, targets_test_original, test_visual = get_arrays(test_loader, model, device, dataset  = dataset)
