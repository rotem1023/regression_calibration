...
def save_current_snapshot(base_model, likelihood, dataset, e, model, save_x, save_y):
    suffix =''
    if save_x:
        suffix = 'x'
    if save_y:
        suffix = f'{suffix}y'
    filename = f'/home/dsi/rotemnizhar/dev/regression_calibration/src/models/snapshots/one_dim/{base_model}_{likelihood}_{dataset}_snapshot_{suffix}.pth.tar'
